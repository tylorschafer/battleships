...
class Computer
  ...
  def cruiser_placement
    ...
    elsif @board.valid_placement?(@cruiser, cruiser_location)
      @board.place(@cruiser, cruiser_location)
    elsif @board.valid_placement?(@cruiser, cruiser_location)
      @board.place(@cruiser, cruiser_location)
    elsif @board.valid_placement?(@cruiser, cruiser_location)
  ...
  def submarine_placement
    ...
    if @board.valid_placement?(@submarine, submarine_location)
      @board.place(@submarine, submarine_location)
    elsif @board.valid_placement?(@submarine, submarine_location)
      @board.place(@submarine, submarine_location)
    elsif @board.valid_placement?(@submarine, submarine_location)
      @board.place(@submarine, submarine_location)
    elsif @board.valid_placement?(@submarine, submarine_location)
